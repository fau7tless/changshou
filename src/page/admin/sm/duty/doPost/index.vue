    ...
    <fox-page>
        ...
        <fox-content>
            <fox-group class="input-block" column="1">
                ...
                <fox-item label="所在位置" style="width:50%">
                    <fox-group  v-model="sysName" >
                        <fox-checkbox  label="省联社" style="margin-top:8px"></fox-checkbox>
                        <fox-checkbox  label="农商行/村镇银行总行" style="margin-top:8px"></fox-checkbox>
                        <fox-checkbox  label="营业网点" style="margin-top:8px"></fox-checkbox>
                    </fox-group>
                </fox-item>
            </fox-group>
        </fox-content>
