        ...
        methods: {
            ...
            SetRoles() {
                if (this.row === '' || this.row === null) {
                    ...
                    fox.custom.appendPage(this, '/admin/sm/duty/postRoleMap', '设置映射角色', {}, this.$data.row)
                }
            },
            add() {
                let params = {
                ...
                fox.custom.appendPage(this, '/admin/sm/duty/doPost', '新增', params, this.$data, {}, this.query)
            },
            update() {
                if (this.row === '' || this.row === null) {
                    this.$alert('必须先选中一条数据')
                    ...
                    fox.custom.appendPage(this, '/admin/sm/duty/doPost', '修改', params, this.$data.row, {}, this.query)
                }
            },
            del() {
                if (this.row === '' || this.row === null) {
