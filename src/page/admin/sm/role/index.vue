  ...
  export default {
    ...
    methods: {
      ...
      SetRoles() {
        ...
        // } else {
        fox.custom.appendPage(this, '/admin/sm/role/roleGroupMap', '设置映射角色', {}, this.$data.row)
        // }
      },
      ViewPost() {
        // if (this.row === '' || this.row === null) {
        //     this.$alert('必须先选中一条数据')
        // } else {
        fox.custom.appendPage(this, '/admin/sm/role/rolePostMap', '查看已配置角色的岗位', {}, this.$data.row)
        // }
      },
      add() {
        let params = {
        ...
        fox.custom.appendPage(this, '/admin/sm/role/doRole', '新增', params, this.$data, {}, this.query)
      },
      update() {
        // if(this.row === '' || this.row === null){
        //     this.$alert('必须先选中一条数据')
        ...
        fox.custom.appendPage(this, '/admin/sm/role/doRole', '修改', params, this.$data.row, {}, this.query)
        // }
      },
      del() {
         if (this.row === '' || this.row === null) {
