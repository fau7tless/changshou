            ...
            <fox-group class="wrapper">
                ...
                <fox-group class="wrapper_right">
                    ...
                    >
                        ...
                        <fox-table-column prop="deadline" label="有效期至"></fox-table-column>
                        <fox-table-column prop="certType" label="登录方式"></fox-table-column>
                    </fox-table-item>
                </fox-group>
            </fox-group>
        </fox-content>
    ...
    export default {
        ...
        methods: {
            ...
            add() {
                ...
                fox.custom.appendPage(this, '/admin/sm/user/doTelllerInfo', '柜员新增', params, this.$data, {}, this.userQuery)
            },
            userRefresh() {
            ...
            update() {
                if (this.row == '' || this.row == null) {
                    ...
                    this.$data.row.deadline = this.formatDate(this.$data.row.deadline)
                    fox.custom.appendPage(this, '/admin/sm/user/doTelllerInfo', '柜员修改', params, this.$data.row, {}, this.userQuery)
                }
            },
            formatDate(shDate){
                let t1 = shDate.split('-');
                let date = new Date(t1[0],t1[1]-1,t1[2],0,0);
                return date;
            },
            startUse() {
